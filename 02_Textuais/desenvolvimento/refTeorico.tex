...
aquisição ao descarte~\cite{zamzam2021prioritisation}. A gestão de tecnologia
médico-hospitalar (GTMH) abrange atividades como incorporação, inventário,
manutenção, controle de desempenho e desativação dos equipamentos, com o objetivo
de assegurar disponibilidade, confiabilidade e
segurança~\cite{park2025evaluation}. No Brasil, o gerenciamento de tecnologias em
saúde nos estabelecimentos é objeto de regulamentação sanitária
específica~\cite{toscas2023management}.

\todo[inline]{Falta apenas a norma sanitária brasileira (ex.: ANVISA RDC nº
509/2021) --- não coberta pelos artigos-fonte; buscar e inserir em formato ABNT.}
...
preditiva (baseada no monitoramento da condição do
equipamento)~\cite{zamzam2021prioritisation}. O histórico de
...
sua vida útil econômica~\cite{park2025evaluation}. O acompanhamento desses
indicadores ao longo do tempo fornece subsídios para decidir entre manter ou
...
traz maior retorno em segurança e em
eficiência~\cite{park2025evaluation,zamzam2021prioritisation}. Abordagens
multicritério desse tipo (como AHP e TOPSIS) são amplamente empregadas no apoio à
decisão em gestão de ativos e fundamentam o modelo de otimização adotado neste
trabalho~\cite{huang2024transforming}.
...
extrair dados de fontes diversas, transformá-los para um formato consistente ---
incluindo a normalização de escalas e de formatos
heterogêneos~\cite{sinsomboonthong2022performance} --- e carregá-los em um destino
de análise. Trata-se de uma abordagem fundamental
...
\todo[inline]{ETL, BI e visualização de dados não são cobertos pelos
artigos-fonte; buscar refs específicas (ex.: Kimball para ETL; literatura de
BI/dashboards) e inserir em formato ABNT.}
